...
export class UserRepository {
  ...
  private allowedFields:string[]=["id","created_at","name","email","phone","role","password","is_premium"];
  ...
  private cleanData(data:Partial<User>){
  ...
  private async exists(id:string, created_at:string){
    ...
    const query = "SELECT id FROM user WHERE id=? AND created_at=?";
  ...
  async find_one(id:string, created_at:string){
    ...
    const query = "SELECT * FROM user WHERE id=? AND created_at=?";
  ...
  async find_all(){
    const res = await this.execute("SELECT * FROM user");
  ...
  async find_by(condition:any){
    ...
    for(const q of queries){
      ...
      const res = await this.execute(
        `SELECT * FROM user WHERE ${q.clause} ALLOW FILTERING`,
        q.values
      );
...
async insert_many_batch(items: User[]) {
  ...
  async update_one(id:string, created_at:string,data:Partial<User>){
  ...
  async update_all(rows:any[] = [], data:Partial<User>){
  ...
  async update_by(condition:any, data:Partial<User>){
  ...
  async delete_one(id:string, created_at:string){
    ...
    const query = "DELETE FROM user WHERE id=? AND created_at=?";
  ...
  async delete_all(){
    await this.execute("TRUNCATE user");
    this.cache.clear();
